		...
		<div className="Users">
			<table>
				<tbody>
					...
					<tr>
						<td><input type="text" ref={firstNameRef} value={firstName} onChange={handleChangeFirstName} /></td>
						<td><input type="text" value={lastName} onKeyPress={handleKeyPress} onChange={handleChangeLastName} /></td>
